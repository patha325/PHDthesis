...
It should be mentioned that for future runs the conversion between photoelectrons to deposited energy will be available and will make the distinction between pions and muons easier.
...
The distributions of these variables for signal and background can be seen in \FigRef{fig:TMVAinput} where no pre-selection or cuts have been made to the data before applying the TMVA.
