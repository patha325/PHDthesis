...
The main goals are to perform precision measurements of neutrino oscillations to determine $\delta_{CP}$ to within $5\sigma$ or more, to determine the neutrino mass ordering, seen in \FigRef{fig:dune1}, and to measure the octant of the mixing angle $\theta_{23}$ all with improved precision.
