...
\caption{Schematic view of the horizontal bar and light yield curves~\cite{112Sascha1} where the y-axis represents number of bars recorded. The blue histogram represent data for each of the horizontal bars and the red curve represents the best Gaussian fit to the data.}
...
\caption{The test beam Baby MIND design, in yellow the magnet modules and in blue the scintillator modules. The red dots and x refer to the magnetic field direction.}
\label{fig:design}
\end{figure}
...
\subsection{Motivation}
The main goals of the proposed detector are to improve the charged current cross section ratio between water and scintillator targets and to perform high-precision measurement of different charged current neutrino interaction channels.
