...
These variables can be seen in \FigRef{fig:TMVANeuinput}.
...
In \FigRef{fig:IronMINDfittedcharge} the efficiency does not start at 0 as the few tracks which have been fitted can provide a charge. 
